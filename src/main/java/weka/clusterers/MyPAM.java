 ...
 *
 * @author Jian Lu (jlu1@cs.uml.edu)
 * @version DataMiningProject
 */
public class MyPAM
 ...
 ***********************************************************************/
     ...
     */
    protected boolean m_SaveClusterResult = false;
 ...
 ***********************************************************************/
     ...
     *  - Only numerica attributes accepted
    ...
    public String toString() {
        ...
        buff.append("But the buff content will not dispaly if m_BestMedoid if null");
    ...
    /**
     * The main function of the MyPAM algorithm
     *
     * @param argv
     */
    public static void main (String[] argv) throws Exception {
        ...
        breader = new BufferedReader(new FileReader(
                "C:\\Users\\AZER\\Desktop\\Weka_Clustring\\src\\main\\resources\\data\\pam_big.arff"));
